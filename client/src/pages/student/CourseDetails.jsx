...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating, calculateCourseDuration, calculateNoofLecture, calculateChapterTime, currency}= useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-400'>
          <h1 className='md:text-5xl text-5xl font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          <p className='pt-4 md:Ltext-base text-sm' dangerouslySetInnerHTML = {{__html : courseData.courseDescription.slice(0,200)}} ></p>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                  ...
                  <p className='text-sm'>Course by <span className='text-blue-500 underline'>Learn Upon</span></p>
        ...
        {/*right column*/}
        <div className='max-w-[424px] z-10 shadow-[0_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-xl overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-500 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
            <div className='pt-6'>
              <p className='md:text-xl tet-lg font-medium text-gray-800'>What's in the course ?</p>
