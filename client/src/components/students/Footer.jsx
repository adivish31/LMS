...
const Footer = () => {
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full'>
      <div className='flex flex-col md:flex-row items-start px-=8 md:px-0 justify-center gap-10 md:gap-32 py-10 borer-b border-white/30'>
      ...
      <p className='py-4 text-center md:text-sm text-xs text-white/60'>Copyright 2025 @ LearUpon. All Rights Reserved</p>
    </footer>
  )
}
